...
Clarifications
There is only ONE queue serving many tills, and The order of the queue NEVER changes, and
...
function queueTime(customers, n) {
  ...
  for (let i = n; i < customers.length; i++) {
    let lowestPos = arr.indexOf(Math.min.apply(null, arr))
    arr[lowestPos] += customers[i];
  }
