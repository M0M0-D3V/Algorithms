...
# https://github.com/John-W-Stevens/algorithms_clrs

def recursive_binary_search(alist, n, low, high):
    mid = high//2

    if alist[mid] == n:
        return True
    if alist[low+1] == alist[high-1]:
        if alist[low] == n or alist[high] == n:
            return True
        else:
            return False

    if alist[mid] > n:
        return recursive_binary_search(alist, n, low, mid+1)
    else:
        return recursive_binary_search(alist, n, mid, high)
